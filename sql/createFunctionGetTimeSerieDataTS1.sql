-- Function: public.gettimeseriedatats1(numeric, timestamp without time zone, integer, integer)

-- DROP FUNCTION public.gettimeseriedatats1(numeric, timestamp without time zone, integer, integer);

CREATE OR REPLACE FUNCTION public.gettimeseriedatats1(numeric, timestamp without time zone, integer, integer)
  RETURNS numeric AS
$BODY$
DECLARE
	x0 numeric;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.gettimeseriedatats1(numeric, timestamp without time zone, integer, integer)
  OWNER TO postgres;
